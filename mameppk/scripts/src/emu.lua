...
files {
	...
	MAME_DIR .. "src/emu/cmddata.c",
	MAME_DIR .. "src/emu/cmdplus.c",
...
dependency {
	...
	--------------------------------------------------
	{ MAME_DIR .. "src/emu/rendfont.c", GEN_DIR .. "emu/uismall11.fh" },
	{ MAME_DIR .. "src/emu/rendfont.c", GEN_DIR .. "emu/uismall14.fh" },
	{ MAME_DIR .. "src/emu/rendfont.c", GEN_DIR .. "emu/uicmd11.fh" },
	{ MAME_DIR .. "src/emu/rendfont.c", GEN_DIR .. "emu/uicmd14.fh" },
	-------------------------------------------------
	-- core layouts
	--------------------------------------------------
...
custombuildtask {
	--FIXME
	{ GEN_DIR .. "emu/%.bdc" .. " " .. MAME_DIR .. "src/build/file2str.py", GEN_DIR .. "emu/%.fh",  MAME_DIR .. "src/build/file2str.py", { "@echo Converting $<...", PYTHON .. " " .. MAME_DIR .. "src/build/file2str.py" ..  " $< $@ font_$(basename $(notdir $<)) UINT8" }},
	{ MAME_DIR.. "src/build/png2bdc.py", GEN_DIR .. "emu/uismall11.bdc",  
		{
		  MAME_DIR .. "src/emu/font/uismall.png",
		  MAME_DIR .. "src/emu/font/cp1250.png",
		}, { "@echo Generating $@...", PYTHON .. " $^ $@" }},
	{ MAME_DIR.. "src/build/png2bdc.py",  GEN_DIR .. "emu/uismall14.bdc", 
		{
	...
	{ MAME_DIR.. "src/build/png2bdc.py", GEN_DIR .. "emu/uicmd11.bdc", 
		{
		  MAME_DIR .. "src/emu/font/cmd11.png",
		}, { "@echo Generating $@...", PYTHON .. " $^ $@" }},
	{ MAME_DIR.. "src/build/png2bdc.py", GEN_DIR .. "emu/uicmd14.bdc", 
		{
