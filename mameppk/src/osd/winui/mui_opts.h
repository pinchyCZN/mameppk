...
#define KAILLERA_LOST_CONNECTION_OPERATION_WINDOW_MODE		1
#define KAILLERA_LOST_CONNECTION_OPERATION_END				2
#define KAILLERA_LOST_CONNECTION_OPERATION_END_ALL_PLAYERS	3
#endif /* KAILLERA */
...
void SetServerPort(unsigned nPort);
