...
static const key_trans_entry win_key_trans_table[] =
{
	...
	{       ITEM_ID_KANA,         DIK_KANA,       0x15,           0, "ITEM_ID_KANA" },
	{       ITEM_ID_CONVERT,      DIK_CONVERT,    0x1c,           0, "ITEM_ID_CONVERT" },
	{       ITEM_ID_NONCONVERT,   DIK_NOCONVERT,  0x1d,           0, "ITEM_ID_NONCONVERT" },
...
static void rawinput_init(running_machine &machine)
{
	...
	if (!machine.options().bool_value("forceuse_dinput"))
