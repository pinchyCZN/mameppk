...
shaders::slider_desc shaders::s_sliders[] =
{
	...
	{ _WINDOWS("Shadow Mask X Count"),                 1,     6,  1024, 1, slider_shadow_mask_x_count },
	{ _WINDOWS("Shadow Mask Y Count"),                 1,     6,  1024, 1, slider_shadow_mask_y_count },
	{ _WINDOWS("Shadow Mask Pixel Count X"),           1,     6,    64, 1, slider_shadow_mask_usize },
	{ _WINDOWS("Shadow Mask Pixel Count Y"),           1,     6,    64, 1, slider_shadow_mask_vsize },
	{ _WINDOWS("Shadow Mask Offset X"),             -100,     0,   100, 1, slider_shadow_mask_uoffset },
	{ _WINDOWS("Shadow Mask Offset Y"),             -100,     0,   100, 1, slider_shadow_mask_voffset },
	{ _WINDOWS("Screen Curvature"),                    0,     3,   100, 1, slider_curvature },
	{ _WINDOWS("Screen Round Corner"),                 0,     3,   100, 1, slider_round_corner },
	{ _WINDOWS("Screen Reflection"),                   0,     3,   100, 1, slider_reflection },
	{ _WINDOWS("Image Vignetting"),                    0,     3,   100, 1, slider_vignetting },
