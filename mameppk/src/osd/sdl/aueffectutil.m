...
- (void)appendFileMenu:(NSMenu *)parent {
	...
	item = [menu addItemWithTitle:@"Openc" action:@selector(openDocument:) keyEquivalent:@"o"];
	...
	item = [menu addItemWithTitle:@"Save Asc" action:@selector(saveDocumentAs:) keyEquivalent:@"S"];
