...
/*
--------------------------------------------------------------
VAG ª˘«√ ±◊∑ÅE(Sony PlayStation compressed ADPCM sound format)

ª˘«√ ±◊∑ÅE∫ 16πŸ¿Ã∆Æ¥‹¿ß∑Œ ¿Ã∑Áæ˚›
...
pack_info: 
 ªÛ¿ß4∫Ò∆Æ:Predictor number 
 «œ¿ß4∫Ò∆Æ:Shiftfactor 

flags: 
 0x07: ª˘«√ ¡æ∑
 0x02: π›∫π ±∏∞£ø° º”«œ¥¬ ª˘«√
 0x06: π›∫π Ω√¿€
 0x04: π›∫π ¿ßƒ°(Repeat Point)
 0x03: ª˘«√ ¡æ∑ÅE π›∫π ¿ßƒ°∫Œ≈Õ Ω√¿€
--------------------------------------------------------------
*/
	...
	for( n_channel = 0; n_channel < MAX_CHANNEL; n_channel++ )
	{
		...
		for( n_sample = 0; n_sample < length; n_sample++ )
		{
			if( chip->m_p_n_blockoffset[ n_channel ] >= ( SAMPLES_PER_BLOCK << PITCH_SHIFT ) )
			{
				...
				// ¡§ªÛ¿˚¿Œ VAG∫˙”∞ø°º≠¥¬ n_predict∞° 4∫∏¥Ÿ ≈´ ∞ÊøÅE° ¿˝¥ÅE¿œæ˚œ™¡ÅEæ ¿Ω 
