...
{
#ifdef KAILLERA
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_ON_SCREEN_DISPLAY,"On Screen Display",      input_seq(KEYCODE_O) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_DEBUG_BREAK,      "Break in Debugger",      input_seq() )
#else
...
#ifdef KAILLERA
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RESET_MACHINE,    "Reset Game",             input_seq(KEYCODE_F3, KEYCODE_RSHIFT) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SOFT_RESET,       "Soft Reset",             input_seq(KEYCODE_F3, input_seq::not_code, KEYCODE_RSHIFT) )
#else
...
#ifdef MAME_AVI
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SNAPSHOT,         "Save Snapshot",          input_seq(KEYCODE_F12, input_seq::not_code, KEYCODE_LSHIFT, input_seq::not_code, KEYCODE_RSHIFT) )
#else
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SNAPSHOT,         "Save Snapshot",          input_seq(KEYCODE_F12, input_seq::not_code, KEYCODE_LSHIFT, input_seq::not_code, KEYCODE_LCONTROL, input_seq::not_code, KEYCODE_LALT) )
#endif /* MAME_AVI */
...
#ifdef KAILLERA
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_HOME,             "UI Home",                input_seq(KEYCODE_HOME, KEYCODE_LSHIFT) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_END,              "UI End",                 input_seq(KEYCODE_END, KEYCODE_LSHIFT) )
#else
...
#ifdef KAILLERA
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_LOAD_STATE,       "Load State",             input_seq(KEYCODE_F7, KEYCODE_RSHIFT) )
#else
...
#ifdef KAILLERA
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_PLAYER_INC,   "Kaiilera Player Shift Up",         input_seq(KEYCODE_F5, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_PLAYER_DEC,   "Kaillera Player Shift Down",       input_seq(KEYCODE_F6, KEYCODE_LSHIFT) )
    //INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_PLAYER_2IN,   "Unused",                           input_seq() )
    //INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_PLAYER_POS,   "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_PLAYER_DUP,   "Kaillera Duplicate Position",      input_seq(KEYCODE_F4, KEYCODE_LSHIFT) )

    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_1,       "Kaillera Auto-save",               input_seq(KEYCODE_F8, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_2,       "Kaillera time level change",       input_seq(KEYCODE_F9, input_seq::not_code, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_3,       "Kaillera Version Check",           input_seq(KEYCODE_F10, KEYCODE_LSHIFT, input_seq::not_code, KEYCODE_RSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_4,       "Kaillera Send Dipswitches",        input_seq(KEYCODE_F3, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_7,       "Killera Select Save Slot",         input_seq(KEYCODE_F9, KEYCODE_LSHIFT) )
    //INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_8,       "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST_9,       "Killera Send Save Data",           input_seq(KEYCODE_F10, KEYCODE_LSHIFT, KEYCODE_RSHIFT) )

    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_0,      "Kaillera Overclock",               input_seq(KEYCODE_F11, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_1,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_2,      "Kaillera Sync Check",              input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_3,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST2_0,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST2_1,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST2_2,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST2_3,      "Unused",                           input_seq() )

    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_4,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_5,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_6,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_7,      "Unused",                           input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_KAILLERA_TEST1_9,      "Clear Chat Log",                   input_seq(KEYCODE_BACKSPACE, KEYCODE_LSHIFT) )

    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_CHAT_OPEN,             "Kaillera Chat Open",               input_seq(KEYCODE_HOME, input_seq::not_code, KEYCODE_LSHIFT) )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_CHAT_CHANGE_MODE,      "Kaillera Chat Change Draw Mode",   input_seq() )
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_CHAT_SHOW_LOG,         "Kaillera Chat Show Chat Log",      input_seq(KEYCODE_END, input_seq::not_code, KEYCODE_LSHIFT) )
#endif /* KAILLERA */
#ifdef MAME_AVI
    INPUT_PORT_DIGITAL_TYPE( 0, SPECIAL,      UI_RECORD_AVI,            "AVI Record",                       input_seq(KEYCODE_F12, KEYCODE_RSHIFT) )
#endif /* MAME_AVI */
}
