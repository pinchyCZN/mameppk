...
#ifdef MAMEUIPLUSPLUS
	optional_shared_ptr<UINT16> m_cps2_ram;

	int          m_region_switch_offset;
	int          m_region_switch_data;
	int          m_region_switch_mask;
	int          m_region_switch_count;
	int          m_region_switch_counter;
#endif /* MAMEUIPLUSPLUS */
#ifdef KAILLERA
	int          m_nvram_type;
#endif /* KAILLERA */
...
#ifdef MAMEUIPLUSPLUS
	DECLARE_READ16_MEMBER(cps2_region_16_r);
#endif /* MAMEUIPLUSPLUS */
