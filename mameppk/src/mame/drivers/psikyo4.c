...
#ifdef JAPANESE
	PORT_DIPNAME( 0x00030000, 0x00000000, DEF_STR( Region ) )
#else
...
#ifdef KAILLERA
INPUT_PORTS_START( hotgmck_k )
	PORT_INCLUDE( hotgmck )

	PORT_START("FAKE")	/* fake port for screen switching */
	//UNUSED_PORT
...
INPUT_PORTS_START( loderndf_k )
	PORT_INCLUDE( loderndf )
...
INPUT_PORTS_START( hotdebut_k )
	PORT_INCLUDE( hotdebut )
...
static const UINT8 loderndf_vs_default_eeprom[256] =
{
...
static MACHINE_CONFIG_DERIVED( loderndf_k, ps4small_k )
	...
	MCFG_EEPROM_SERIAL_93C56_8BIT_ADD("eeprom")
	MCFG_EEPROM_DATA(loderndf_k_default_eeprom, 256)
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( loderndf_vs, ps4small_k )
	...
	MCFG_EEPROM_SERIAL_93C56_8BIT_ADD("eeprom")
	MCFG_EEPROM_DATA(loderndf_vs_default_eeprom, 256)
MACHINE_CONFIG_END
#endif /* KAILLERA */
...
#ifdef KAILLERA
GAME_HACK( 1997, hotgmck_k,  hotgmck,        ps4big_k,   hotgmck_k, driver_device,  0, ROT0,   "Psikyo", "Taisen Hot Gimmick (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1998, hgkairak_k, hgkairak,       ps4big_k,   hotgmck_k, driver_device,  0, ROT0,   "Psikyo", "Taisen Hot Gimmick Kairakuten (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1999, hotgmck3_k, hotgmck3,       ps4big_k,   hotgmck_k, driver_device,  0, ROT0,   "Psikyo", "Taisen Hot Gimmick 3 Digital Surfing (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 2000, hotgm4ev_k, hotgm4ev,       ps4big_k,   hotgmck_k, driver_device,  0, ROT0,   "Psikyo", "Taisen Hot Gimmick 4 Ever (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 2000, loderndf_k,  loderndf,    loderndf_k,  loderndf_k, driver_device,  0, ROT0,   "Psikyo", "Lode Runner - The Dig Fight (ver. B) (Japan / co kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 2000, loderndf_vs, loderndf,   loderndf_vs,  loderndf_k, driver_device,  0, ROT0,   "Psikyo", "Lode Runner - The Dig Fight (ver. B) (Japan / vs kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 2000, hotdebut_k,  hotdebut,    ps4small_k,  hotdebut_k, driver_device,  0, ROT0,   "MOSS / Psikyo", "Quiz de Idol! Hot Debut (Japan / kaillera)", GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
