...
GAME_HACK( 2000, loderndf_k,  loderndf,    loderndf_k,  loderndf_k, loderndf, ROT0,   "Psikyo", "Lode Runner - The Dig Fight (ver. B) (Japan / co kaillera)", 0 )
GAME_HACK( 2000, loderndf_vs, loderndf,   loderndf_vs,  loderndf_k, loderndf, ROT0,   "Psikyo", "Lode Runner - The Dig Fight (ver. B) (Japan / vs kaillera)", 0 )
GAME_HACK( 2000, hotdebut_k,  hotdebut,    ps4small_k,  hotdebut_k, hotdebut, ROT0,   "Psikyo / Moss", "Quiz de Idol! Hot Debut (Japan / kaillera)", 0 )
#endif /* KAILLERA */
