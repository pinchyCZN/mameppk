...
ROM_START( outrunen )
	ROM_REGION( 0x60000, "maincpu", 0 ) // 68000 code
	ROM_LOAD16_BYTE( "epr-10380b.133", 0x000000, 0x10000, CRC(90e6ecec) )
	ROM_LOAD16_BYTE( "epr-10382b.118", 0x000001, 0x10000, CRC(e227af3c) )
	ROM_LOAD16_BYTE( "epr-10381b.132", 0x020000, 0x10000, CRC(0c87bce3) ) // Same as the "A" version belown ???
	ROM_LOAD16_BYTE( "epr-10383b.117", 0x020001, 0x10000, CRC(28a5e93e) )
	...
	ROM_LOAD( "opr-10189.70", 0x40000, 0x08000, CRC(01366b54) SHA1(f467a6b807694d5832a985f5381c170d24aaee4e) )
	ROM_RELOAD(               0x48000, 0x08000 )
	ROM_LOAD( "opr-10188.71", 0x50000, 0x08000, CRC(37598616) )
	ROM_RELOAD(               0x58000, 0x08000 )
ROM_END
