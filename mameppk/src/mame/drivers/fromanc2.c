...
static MACHINE_CONFIG_START( fromanc2_k, fromanc2_state )
	...
	MCFG_SCREEN_SIZE(512, 512)
	MCFG_SCREEN_VISIBLE_AREA(0, 352-1, 0, 240-1)
	MCFG_SCREEN_UPDATE_DRIVER(fromanc2_state,screen_update_fromanc2_k)
...
#ifdef KAILLERA
GAME_HACK( 1995, fromanc2_k, fromanc2, fromanc2_k, fromanc2, fromanc2_state, fromanc2, ROT0, "Video System Co.", "Taisen Idol-Mahjong Final Romance 2 (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1995, fromancr_k, fromancr, fromancr_k, fromanc2, fromanc2_state, fromanc2, ROT0, "Video System Co.", "Taisen Mahjong Final Romance R (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1998, fromanc4_k, fromanc4, fromanc4_k, fromanc4, fromanc2_state, fromanc4, ROT0, "Video System Co.", "Taisen Mahjong Final Romance 4 (Japan / kaillera)", GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
