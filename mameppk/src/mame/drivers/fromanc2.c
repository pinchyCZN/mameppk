...
static MACHINE_CONFIG_START( fromanc2_k, fromanc2_state )
	...
	MDRV_CPU_ADD("maincpu", M68000,32000000/2)		/* 16.00 MHz */
	MDRV_CPU_PROGRAM_MAP(fromanc2_main_map)
	MDRV_CPU_VBLANK_INT("lscreen", fromanc2_k_interrupt)
...
#ifdef KAILLERA
GAME_HACK( 1995, fromanc2_k, fromanc2, fromanc2_k, fromanc2, fromanc2, ROT0, "Video System Co.", "Taisen Idol-Mahjong Final Romance 2 (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1995, fromancr_k, fromancr, fromancr_k, fromanc2, fromanc2, ROT0, "Video System Co.", "Taisen Mahjong FinalRomance R (Japan / kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1998, fromanc4_k, fromanc4, fromanc4_k, fromanc4, fromanc4, ROT0, "Video System Co.", "Taisen Mahjong FinalRomance 4 (Japan / kaillera)", GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
