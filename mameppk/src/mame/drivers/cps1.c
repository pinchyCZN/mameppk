...
GAME( 1992, sf2m14,      sf2ce,    cps1_12MHz, sf2hack,  cps_state,   sf2hack,  ROT0,   "bootleg", "Street Fighter II' - Champion Edition (M14, bootleg)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
