...
ROM_START( striderj )
	...
	ROM_REGION( 0x0200, "bboardplds", 0 )
	ROM_LOAD( "st22b.1a",     0x0000, 0x0117, NO_DUMP )
...
ROM_START( sf2ceuc )
	...
	ROM_LOAD16_WORD_SWAP( "s92_21b.6f",  0x100000, 0x80000, CRC(b383cb1c) SHA1(fd527d5b27a853758bc6ed0f4108f3c634484de6) )
...
GAME( 1992, sf2ceud,     sf2ce,    cps1_12MHz, sf2,        cps1,     ROT0,   "Capcom", "Street Fighter II': Champion Edition (USA 920803, alt)", GAME_SUPPORTS_SAVE )
