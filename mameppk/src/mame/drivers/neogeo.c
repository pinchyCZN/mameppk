...
#if defined(USE_NEOGEO_HACKS) && defined(KAILLERA)
	/* initialize machine country hack */
	if (determine_neogeo_bios() == NEOGEO_BIOS_TYPE_EURO)
	{
		neogeo_machine_country = input_port_read(machine, "HACK_IN5") & 0x03;
		neogeo_machine_mode    = input_port_read(machine, "HACK_IN5") & 0x04;
	}
#endif
...
#define NEOGEO_BIOS \
	...
	ROM_SYSTEM_BIOS(11, "unibios31", "Universe Bios (Hack, Ver. 3.1)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(11, "uni-bios_3_1.rom",  0x00000, 0x020000, CRC(0c58093f) SHA1(29329a3448c2505e1ff45ffa75e61e9693165153) ) /* Universe Bios v3.1 (hack) */ \
	ROM_SYSTEM_BIOS(12, "unibios30", "Universe Bios (Hack, Ver. 3.0)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(12, "uni-bios_3_0.rom",  0x00000, 0x020000, CRC(a97c89a9) SHA1(97a5eff3b119062f10e31ad6f04fe4b90d366e7f) ) /* Universe Bios v3.0 (hack) */ \
	ROM_SYSTEM_BIOS(13, "unibios23", "Universe Bios (Hack, Ver. 2.3)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(13, "uni-bios_2_3.rom",  0x00000, 0x020000, CRC(27664eb5) SHA1(5b02900a3ccf3df168bdcfc98458136fd2b92ac0) ) /* Universe Bios v2.3 (hack) */ \
	ROM_SYSTEM_BIOS(14, "unibios23o", "Universe Bios (Hack, Ver. 2.3, older?)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(14, "uni-bios_2_3o.rom", 0x00000, 0x020000, CRC(601720ae) SHA1(1b8a72c720cdb5ee3f1d735bbcf447b09204b8d9) ) /* Universe Bios v2.3 (hack) alt version, withdrawn? */ \
	ROM_SYSTEM_BIOS(15, "unibios22", "Universe Bios (Hack, Ver. 2.2)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(15, "uni-bios_2_2.rom",  0x00000, 0x020000, CRC(2d50996a) SHA1(5241a4fb0c63b1a23fd1da8efa9c9a9bd3b4279c) ) /* Universe Bios v2.2 (hack) */ \
	ROM_SYSTEM_BIOS(16, "unibios21", "Universe Bios (Hack, Ver. 2.1)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(16, "uni-bios_2_1.rom",  0x00000, 0x020000, CRC(8dabf76b) SHA1(c23732c4491d966cf0373c65c83c7a4e88f0082c) ) /* Universe Bios v2.1 (hack) */ \
	ROM_SYSTEM_BIOS(17, "unibios20", "Universe Bios (Hack, Ver. 2.0)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(17, "uni-bios_2_0.rom",  0x00000, 0x020000, CRC(0c12c2ad) SHA1(37bcd4d30f3892078b46841d895a6eff16dc921e) ) /* Universe Bios v2.0 (hack) */ \
	ROM_SYSTEM_BIOS(18, "unibios13", "Universe Bios (Hack, Ver. 1.3)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(18, "uni-bios_1_3.rom",  0x00000, 0x020000, CRC(b24b44a0) SHA1(eca8851d30557b97c309a0d9f4a9d20e5b14af4e) ) /* Universe Bios v1.3 (hack) */ \
	ROM_SYSTEM_BIOS(19, "unibios12", "Universe Bios (Hack, Ver. 1.2)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(19, "uni-bios_1_2.rom",  0x00000, 0x020000, CRC(4fa698e9) SHA1(682e13ec1c42beaa2d04473967840c88fd52c75a) ) /* Universe Bios v1.2 (hack) */ \
	ROM_SYSTEM_BIOS(20, "unibios12o", "Universe Bios (Hack, Ver. 1.2, older)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(20, "uni-bios_1_2o.rom", 0x00000, 0x020000, CRC(e19d3ce9) SHA1(af88ef837f44a3af2d7144bb46a37c8512b67770) ) /* Universe Bios v1.2 (hack) alt version */ \
	ROM_SYSTEM_BIOS(21, "unibios11", "Universe Bios (Hack, Ver. 1.1)" ) \
	ROM_LOAD16_WORD_SWAP_BIOS(21, "uni-bios_1_1.rom",  0x00000, 0x020000, CRC(5dda0d84) SHA1(4153d533c02926a2577e49c32657214781ff29b7) ) /* Universe Bios v1.1 (hack) */ \
...
ROM_START( ssh5spnd )
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "272-p1p.rom", 0x000000, 0x800000, CRC(339F5081) )

	NEO_SFIX_128K( "272d-s1.rom", CRC(C297F973) )

	NEO_BIOS_AUDIO_128K( "272d-m1.rom", CRC(0b5d4d6a) )

	ROM_REGION( 0x1000000, "ym", 0 )
	ROM_LOAD( "272-v1d.rom", 0x000000, 0x400000, CRC(4D1B252B) ) // vconv
	ROM_LOAD( "272-v2d.bin", 0x400000, 0x400000, CRC(0e46d2f8) ) // vconv
	ROM_LOAD( "272-v3d.rom", 0x800000, 0x400000, CRC(3f0f7554) ) // vconv
	ROM_LOAD( "272-v4d.bin", 0xc00000, 0x400000, CRC(ad8fabb4) ) // vconv
	NO_DELTAT_REGION

	ROM_REGION( 0x4000000, "sprites", 0 )/* Not Encrypted */
	ROM_LOAD16_BYTE( "272-c1d.bin", 0x0000000, 0x800000, CRC(8548097e) )
	ROM_LOAD16_BYTE( "272-c2d.bin", 0x0000001, 0x800000, CRC(8c1b48d0) )
	ROM_LOAD16_BYTE( "272-c3d.bin", 0x1000000, 0x800000, CRC(96ddb28c) )
	ROM_LOAD16_BYTE( "272-c4d.bin", 0x1000001, 0x800000, CRC(99ef7a0a) )
	ROM_LOAD16_BYTE( "272-c5d.bin", 0x2000000, 0x800000, CRC(772e8b1e) )
	ROM_LOAD16_BYTE( "272-c6d.bin", 0x2000001, 0x800000, CRC(5fff21fc) )
	ROM_LOAD16_BYTE( "272-c7d.bin", 0x3000000, 0x800000, CRC(9ac56a0e) )
	ROM_LOAD16_BYTE( "272-c8d.bin", 0x3000001, 0x800000, CRC(cfde7aff) )
ROM_END
...
GAME( 1990, mahretsu,   neogeo,   neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "Mahjong Kyo Retsuden (NGM-004)(NGH-004)", GAME_SUPPORTS_SAVE ) // does not support mahjong panel in MVS mode
...
GAME( 1995, kof95a,     kof95,    neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "SNK", "The King of Fighters '95 (NGM-084), alternate board", GAME_SUPPORTS_SAVE )
...
GAME( 1996, kizuna4p,   kizuna,   neogeo,   kizuna4p, neogeo_state, neogeo,   ROT0, "SNK", "Kizuna Encounter - Super Tag Battle 4 Way Battle Version / Fu'un Super Tag Battle Special Version", GAME_SUPPORTS_SAVE )
...
GAME( 1998, kof98a,     kof98,    neogeo,   neogeo, neogeo_state,   kof98,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (NGM-2420, alternate board)", GAME_SUPPORTS_SAVE )
...
GAME( 2003, ms5pcb,     0,        neogeo,   dualbios, neogeo_state, ms5pcb,   ROT0, "SNK Playmore", "Metal Slug 5 (JAMMA PCB)", GAME_SUPPORTS_SAVE )
GAME( 2003, ms5plus,    mslug5,   neogeo,   neogeo, neogeo_state,   ms5plus,  ROT0, "bootleg", "Metal Slug 5 Plus (bootleg)", GAME_SUPPORTS_SAVE )
GAME( 2003, svcpcb,     0,        neogeo,   dualbios, neogeo_state, svcpcb,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 1)", GAME_SUPPORTS_SAVE ) // not a clone of neogeo because it's NOT a neogeo cart.
GAME( 2003, svcpcba,    svcpcb,   neogeo,   dualbios, neogeo_state, svcpcb,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 2)" , GAME_SUPPORTS_SAVE ) /* Encrypted Code */
...
#ifdef MAMEUIPLUSPLUS
/* Yuki Enterprise */
GAME( 2004, ssh5spnd, samsh5sp, neogeo,   neogeo, neogeo_state,   neogeo,   ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (non encrypted P, decrypted C)", GAME_SUPPORTS_SAVE )
#endif /* MAMEUIPLUSPLUS */

#ifdef KAILLERA
/* SNK */
GAME_HACK( 1990, lbowling4p, lbowling,   neogeo, neogeo, neogeo_state,  neogeo,   ROT0, "SNK", "League Bowling (4 Players for kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1995, kof95_6p,   kof95,      neogeo, neogeo, neogeo_state,  neogeo,   ROT0, "SNK", "The King of Fighters '95 (6 Players for kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1998, kof98_6p,   kof98,      neogeo, neogeo, neogeo_state,  kof98,    ROT0, "SNK", "The King of Fighters '98 (6 Players for kaillera)", GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
