...
ROM_START( bublcave )
	ROM_REGION( 0x30000, "maincpu", 0 )
	ROM_LOAD( "a78-06-1.51",    0x00000, 0x08000, CRC(e8b9af5e) )
	/* ROMs banked at 8000-bfff */
	ROM_LOAD( "a78-05-1.52",    0x10000, 0x10000, CRC(cfe14cb8) )
	/* 20000-2ffff empty */
...
GAME( 2013, bublcave,  	bublbobl, bublbobl, bublbobl, bublbobl_state, bublbobl, ROT0,  "hack by Bisboch and Aladar", "Bubble Bobble Lost Cave (Ver 1.2)", GAME_SUPPORTS_SAVE )
GAME( 2013, bublredux,  bublbobl, boblbobl, boblbobl, bublbobl_state, bublbobl, ROT0,  "hack", "Bubble Bobble Redux (With Level Skipper)", GAME_SUPPORTS_SAVE )
