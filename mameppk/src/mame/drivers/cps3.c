...
#ifdef MAMEUIPLUSPLUS
GAME_HACK( 1999, jojobap, jojobanr1, jojoba, cps3_jojo, cps3_state, jojoba,   ROT0, "Capcom", "JoJo no Kimyouna Bouken: Miraie no Isan (Japan 990913 / Ex Chars)", GAME_IMPERFECT_GRAPHICS )
#endif /* MAMEUIPLUSPLUS */
