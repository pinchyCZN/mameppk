...
#ifdef KAILLERA
GAME_HACK( 2000, kov2106_4p, kov2106,pgm_arm_type2,    kov2, pgm_arm_type2_state,    kov2_4p,    ROT0,   "IGS", "Knights of Valour 2 / Sangoku Senki 2 (ver. 106 / 4 Players for kaillera)", GAME_IMPERFECT_SOUND | GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
...
#ifdef KAILLERA
GAME_HACK( 2001, kov2p4p, kov2p,     pgm_arm_type2,    kov2, pgm_arm_type2_state,    kov2p4p,    ROT0,   "IGS", "Knights of Valour 2 Plus - Nine Dragons / Sangoku Senki 2 Plus - Nine Dragons (ver. M204XX / 4 Players for kaillera)", GAME_IMPERFECT_SOUND | GAME_UNEMULATED_PROTECTION | GAME_NOT_WORKING | GAME_SUPPORTS_SAVE ) /* need internal rom of IGS027A */
#endif /* KAILLERA */
...
GAME( 1998, olds103t,     olds,      pgm,               pgm,  pgm_state,             pgm,        ROT0,   "IGS", "Oriental Legend Special / Xi You Shi E Zhuan Super (ver. 103, China, Tencent) (unprotected)", GAME_IMPERFECT_SOUND | GAME_SUPPORTS_SAVE ) // why is this version not protected? internal leak? bootleg?
