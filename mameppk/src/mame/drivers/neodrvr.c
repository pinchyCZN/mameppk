...
#ifdef MAMEUIPLUSPLUS
/* Yuki Enterprise */
GAME( 2004, ssh5spnd, samsh5sp, neogeo,   neogeo,   neogeo,   ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (non encrypted P, decrypted C)", GAME_SUPPORTS_SAVE )
#endif /* MAMEUIPLUSPLUS */

#ifdef KAILLERA
/* SNK */
GAME_HACK( 1990, lbowling4p, lbowling,   neogeo, neogeo,  neogeo,   ROT0, "SNK", "League Bowling (4 Players for kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1995, kof95_6p,   kof95,      neogeo, neogeo,  neogeo,   ROT0, "SNK", "The King of Fighters '95 (6 Players for kaillera)", GAME_SUPPORTS_SAVE )
GAME_HACK( 1998, kof98_6p,   kof98,      neogeo, neogeo,  kof98,    ROT0, "SNK", "The King of Fighters '98 (6 Players for kaillera)", GAME_SUPPORTS_SAVE )
#endif /* KAILLERA */
