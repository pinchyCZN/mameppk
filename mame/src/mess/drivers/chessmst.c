...
{
	chessmst_state *state = field.machine().driver_data<chessmst_state>();
	UINT8 pos = (UINT8)(FPTR)param;

	if (newval)
	{
		state->m_sensor[pos] = !state->m_sensor[pos];
	}
}
...
static INPUT_PORTS_START( chessmst )
	PORT_START("COL_A")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  0)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  1)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  2)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  3)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  4)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  5)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  6)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  7)
	PORT_START("COL_B")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  8)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor,  9)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 10)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 11)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 12)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 13)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 14)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 15)
	PORT_START("COL_C")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 16)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 17)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 18)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 19)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 20)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 21)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 22)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 23)
	PORT_START("COL_D")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 24)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 25)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 26)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 27)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 28)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 29)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 30)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 31)
	PORT_START("COL_E")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 32)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 33)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 34)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 35)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 36)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 37)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 38)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 39)
	PORT_START("COL_F")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 40)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 41)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 42)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 43)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 44)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 45)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 46)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 47)
	PORT_START("COL_G")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 48)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 49)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 50)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 51)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 52)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 53)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 54)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 55)
	PORT_START("COL_H")
		PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 56)
		PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 57)
		PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 58)
		PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 59)
		PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 60)
		PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 61)
		PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 62)
		PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_KEYPAD)	PORT_CHANGED(chessmst_sensor, 63)
