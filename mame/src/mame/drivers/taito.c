...
GAME(198?,	taitest,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Taito Test Fixture",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	cavnegro,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Cavaleiro Negro",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	cavnegro1,	cavnegro,	taito,	taito,	taito,	ROT0,	"Taito",	"Cavaleiro Negro (alternate set 1)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	cavnegro2,	cavnegro,	taito,	taito,	taito,	ROT0,	"Taito",	"Cavaleiro Negro (alternate set 2)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	cosmic,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Cosmic",				GAME_IS_SKELETON_MECHANICAL)
GAME(1980,	drakor,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Drakor",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	fireact,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Fire Action",				GAME_IS_SKELETON_MECHANICAL)
GAME(198?,	fireactd,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Fire Action Deluxe",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	gemini2k,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Gemini 2000",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	gemini2k1,	gemini2k,	taito,	taito,	taito,	ROT0,	"Taito",	"Gemini 2000 (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	gork,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Gork",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	hawkman,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Hawkman",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	hawkman1,	hawkman,	taito,	taito,	taito,	ROT0,	"Taito",	"Hawkman (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	ladylukt,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Lady Luck (Taito)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	lunelle,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Lunelle",				GAME_IS_SKELETON_MECHANICAL)
GAME(1980,	meteort,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Meteor (Taito)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1984,	mrblack,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black",				GAME_IS_SKELETON_MECHANICAL)
GAME(1985,	mrblack1,	mrblack,	taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1980,	obaoba,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Oba-Oba",				GAME_IS_SKELETON_MECHANICAL)
GAME(1980,	obaoba1,	obaoba,		taito,	taito,	taito,	ROT0,	"Taito",	"Oba-Oba (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(198?,	polar,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Polar Explorer",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	rally,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Rally",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	sharkt,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Shark (Taito)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1979,	shock,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Shock",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	snake,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Snake Machine",				GAME_IS_SKELETON_MECHANICAL)
GAME(1985,	sshuttle,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Space Shuttle (Taito)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1985,	sshuttle1,	sshuttle,	taito,	taito,	taito,	ROT0,	"Taito",	"Space Shuttle (Taito) (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	stest,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Speed Test",				GAME_IS_SKELETON_MECHANICAL)
GAME(1981,	sureshop,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Sure Shot (Pinball)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	titan,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Titan",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	titan1,		titan,		taito,	taito,	taito,	ROT0,	"Taito",	"Titan (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(198?,	vegast,		ladylukt,	taito,	taito,	taito,	ROT0,	"Taito",	"Vegas (Taito)",				GAME_IS_SKELETON_MECHANICAL)
GAME(198?,	voleybal,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Voley Ball",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	vortexp,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Vortex (Pinball)",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	zarza,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Zarza",				GAME_IS_SKELETON_MECHANICAL)
GAME(1982,	zarza1,		zarza,		taito,	taito,	taito,	ROT0,	"Taito",	"Zarza (alternate set)",				GAME_IS_SKELETON_MECHANICAL)
GAME(198?,	mrblkz80,	mrblack,	taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black (Z-80 CPU)",				GAME_IS_SKELETON_MECHANICAL)
