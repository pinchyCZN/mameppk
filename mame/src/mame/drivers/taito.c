...
GAME(1981,	ladylukt,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Lady Luck (Taito)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	lunelle,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Lunelle",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1980,	meteort,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Meteor (Taito)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1984,	mrblack,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1985,	mrblack1,	mrblack,	taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black (alternate set)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1980,	obaoba,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Oba-Oba",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1980,	obaoba1,	obaoba,		taito,	taito,	taito,	ROT0,	"Taito",	"Oba-Oba (alternate set)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(198?,	polar,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Polar Explorer",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	rally,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Rally",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	sharkt,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Shark (Taito)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(1982,	titan1,		titan,		taito,	taito,	taito,	ROT0,	"Taito",	"Titan (alternate set)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(198?,	vegast,		ladylukt,	taito,	taito,	taito,	ROT0,	"Taito",	"Vegas (Taito)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(198?,	voleybal,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Voley Ball",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	vortexp,	0,			taito,	taito,	taito,	ROT0,	"Taito",	"Vortex (Pinball)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	zarza,		0,			taito,	taito,	taito,	ROT0,	"Taito",	"Zarza",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1982,	zarza1,		zarza,		taito,	taito,	taito,	ROT0,	"Taito",	"Zarza (alternate set)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(198?,	mrblkz80,	mrblack,	taito,	taito,	taito,	ROT0,	"Taito",	"Mr. Black (Z-80 CPU)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
